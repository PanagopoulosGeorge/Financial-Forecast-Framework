import requests
from src.OECD.urls import LAST_HISTORICAL_DATE_URL
from datetime import datetime

def write_last_historical_date():
    url = LAST_HISTORICAL_DATE_URL
    ...
    # The payload/body of the POST request (adjust this based on the actual request payload)
    payload = {
      "lang": "en",
      "search": "",
    ...
    if response.status_code == 200:
        ...
        with open('last_historical_date.txt', 'w') as f:
